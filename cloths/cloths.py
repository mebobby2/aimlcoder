...
# It takes some experimentation over time to pick the right values. This process is typi‐ cally called hyperparameter tuning. In machine learning, a hyperparameter is a value that is used to control the training, as opposed to the internal values of the neurons that get trained/learned, which are referred to as parameters.
